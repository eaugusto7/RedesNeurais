...
sensor_files = ['acelerometro_dinamico.csv', 'gyro_dinamico.csv', 'gnss_dinamico.csv', 'in_profile_dinamico.csv']
...
test_sensor_files = ['acelerometro_dinamico_test.csv', 'gyro_dinamico_test.csv', 'gnss_dinamico_test.csv']
...
test_data_with_predictions.to_csv('PredictedOutput_Dinamico.csv', index=False)
